...
class AttackMetrics:
    ...
    def get_report(self):
        ...
        return {
            ...
            "attempts_per_second": round(self.attempts / total_time, 2) if total_time > 0 else 0,
            "time_to_breach_seconds": round(self.breach_time, 2) if self.breach_time else None,
            "success_rate": round(self.successful_attempts / self.attempts * 100, 2) if self.attempts > 0 else 0,
